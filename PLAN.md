...
| **B — people** | 14–20 Sep | ✅ **S2/S3/S4** server · ✅ **Y2/W3** transport · ✅ **U4** members+ceremony · ✅ **U6** inbox · ✅ **W2** S0.9 → remaining: **U5** family money · **U6** close · **U7** recovery screens | two phones sync (⛔ blocked on the `CryptoGuard` identity accessor); **TestFlight to the owner's family** |
