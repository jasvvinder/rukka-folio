...
- Build: `/cycle <keys>` (build → review → verify → repair; ≤3 slices) · `/lane <keys>` (build only, ≤3 lanes) · `/gate [lane]` (separate run, always) · `/close` (plan → changelog → clear)
