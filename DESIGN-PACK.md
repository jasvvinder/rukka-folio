...
**Dark (required):** bg `#1A1A18` · surface `#24231F` · text `#F5F0E4` · muted `#A5A093` · hairline `#3A382F` · primary `#93A5D6` · accent `#D9754F` · money-in `#57A87F` · money-out `#C96A63` · pending `#D9A93F` · locked `#7A756A`
