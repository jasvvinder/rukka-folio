...
> **ADR 2026-09-25 §5–§6** — plans follow the entity type chosen at signup (2–3 each; 30-day trial on the popular plan for Family, Business and Trust; permanent Free for Individual with no statement import and no PDF output); book-flow features are never restricted on any plan; plans live in a **server-side catalogue** edited in the admin console, and the token gains `features`. **Until the M13 catalogue lane lands, the table below is the interim catalogue.** ⟦tests: G-25-1 @M13, G-25-2 @M13, G-25-3 @M13, E-25-3 @M13, G-25-4 @M13, F1-25-5 @M13⟧
...
## 3.1 Upgrade flow 🔒 (owner-approved) ⟦tests: G-08-7 @M13⟧
...
## 3.2 App Store consequence of shipping iOS first — 🔒 **ruled option 1 (ADR 2026-09-05g §8)** ⟦tests: G-08-8 @M13⟧
...
## 4. Billing plumbing 🔒 ⟦tests: G-08-9⟧
