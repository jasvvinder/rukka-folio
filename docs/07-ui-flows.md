...
| **Our trust** | ″ | **O6g** name the trust **and its type** (gurudwara · temple · society · registered trust) → **O6h** *"Who runs it?"* — Chairman, President, Trustees, Sevadars invited by phone, skippable → **O6i** the trust's accounts — bank, **Cash A/c (in hand)** and the **gollak as `cash_collection`**, denomination counting on for every cash account; the gollak empties only into the Cash A/c (02 §8.2) → checklist |
