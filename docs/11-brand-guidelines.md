# Rukka Folio — Brand Guidelines v1.3
...
| Strap | x28 w14, full book height (y12–76), paper @93% | Contracts to x24 w9 (translateX −4, scaleX 0.643), 62% opacity |
...
| Margins | **6 units** from book edge — seal's left extent and entries' right extent | Same 6 on both sides |
